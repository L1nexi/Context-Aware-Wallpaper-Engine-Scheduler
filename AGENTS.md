...
本文件为在本仓库中工作的编码代理提供协作约束。内容基于 2026-05-03 的代码现状编写，用于补齐并更新 `CLAUDE.md` 中已经过时的部分。
...
- 如果你在做 Dashboard 分析页重构，可以按 `docs/frontend/DASHBOARD_ANALYSIS_SPEC.md` 新建更正确的分析接口，而不是继续扩展旧 `TickState`
