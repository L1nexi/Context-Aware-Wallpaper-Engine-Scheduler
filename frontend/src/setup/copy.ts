...
const zh = {
  ...
  steps: [
    { title: "Wallpaper Engine", short: "找到安装位置并读取播放列表" },
    { title: "天气服务", short: "填写 OpenWeatherMap API Key" },
    { title: "所在地点", short: "设置用于天气判断的位置" },
    { title: "场景绑定", short: "把使用情境连接到播放列表" },
    { title: "调度体验", short: "决定响应方式和打扰程度" },
    { title: "Activity 检测", short: "识别工作与休闲活动" },
    { title: "检查并完成", short: "确认草稿并一次性保存" },
  ],
  nav: {
...
const en: typeof zh = {
  ...
  steps: [
    { title: "Wallpaper Engine", short: "Find the installation and read playlists" },
    { title: "Weather service", short: "Enter an OpenWeatherMap API key" },
    { title: "Location", short: "Set the location used for weather" },
    { title: "Scene assignments", short: "Connect contexts to playlists" },
    { title: "Scheduling feel", short: "Choose responsiveness and interruption" },
    { title: "Activity detection", short: "Recognize work and leisure activity" },
    { title: "Review and finish", short: "Review the draft and save once" },
  ],
  nav: {
