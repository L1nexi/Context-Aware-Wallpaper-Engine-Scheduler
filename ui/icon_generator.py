...
class IconGenerator:
    ...
    def generate(paused=False, size=64):
        ...
        dc.ellipse([4, 4, canvas_size - 4, canvas_size - 4], fill=IconGenerator.COLORS["base"])

        # 3. Draw Outer Ring (The "Sensor" feel)
        # Thick stroke
        stroke_width = canvas_size // 10
        dc.ellipse([10, 10, canvas_size - 10, canvas_size - 10], outline=main_color, width=stroke_width)
